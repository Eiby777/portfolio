...
export const ProjectContainer = styled.section<{ $bgColor: string }>`
  ...
  &::before {
    ...
    right: 0;
    bottom: 0;
    background: radial-gradient(circle at 70% 30%, rgba(255, 102, 0, 0.12) 0%, transparent 50%);
    pointer-events: none;
  }
  ...
  &::after {
    ...
    width: 40%;
    height: 40%;
    background: radial-gradient(circle at 100% 100%, rgba(255, 102, 0, 0.08) 0%, transparent 60%);
    pointer-events: none;
  }
`;
